...
#Two columns are entirely empty, several values in the 100,000 deaths per column are missing as well, and the names for columns 2 and 3 make it difficult to interpret the data. It's hard to tell what the findings and the functions will be made difficult because of the names.
