...
# Write the answer in a comment
# Q: What was the average number of cases per county in each state? Which state had the lowest average?
# A: Vermont, with 114.8571 cases on average per county
...
# A: New Jersey, with 758.905 deaths on average per county
...
```{r}
# Q: How many cases did the average state in the U.S. have on August 30?

us_state_average_covid_cases <- covid_state %>%
  summarise(cases_in_average_state = mean(total_cases))

# Display the object below.
us_state_average_covid_cases

#A: There were 116,784.8 cases in the average U.S. state on August 30.
