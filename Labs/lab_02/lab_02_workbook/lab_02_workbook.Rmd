...
read_csv("data/arcos-md-baltimore-city-24510-pharmacy.csv")
```
...
```{r}
# Answer to question 1: Giant Pharmacy 166; 10,365 shipments
...
```{r}
# Answer to question 2: Oshinsky, Alan E MD and Jakobovits, Julian MD each received just 4 pills.
