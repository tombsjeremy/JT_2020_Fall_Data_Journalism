...
baltimore_city_may_august <- baltimore_city %>%
...
#My coordinates on the x axis were going from August to May (left to right, so it was descending) and I could not figure out how to rearrange them. As such, the "coord_flip" and "xlab" lines were functions I found online and provided a solution to the issue. Hopefully this is okay. 

baltimore_city_may_august %>%
  ggplot(aes(month, case_rate)) +
