...
# A: Prince George's County; 29.27 cases per 1000
...
# A: Bath County; 0.91 cases per 1000 (highest was Greensville, with 60.55 per 1000, not sure which you were looking for)
...
# A: Two areas; Hancock County, Georgia (4.569) and Galax City County, Virginia (4.218)
...
# A: Kent County (1.22 deaths per 1000)
...
# A: Galax City County (4.218), Emporia City County (2.97), and Northampton (2.425)
...
# A: The largest percentage jump was made in Luce County, Michigan, a 2,925 percent increase.
...
# A: Queen Anne's County, a 52.9 percent increase
...
covid_texas_may_aug_pct_change <- covid_county_monthly_case_rate %>%
...
# Answer is Jones County, Texas with a 49 percent increase in case rate
...
# Question: Which county in Florida had the biggest increase in cumulative case rate between the months of June and August? What was the percentage change?
...
# Answer: Franklin County, Florida with an 89.33 percent increase between June and August.
