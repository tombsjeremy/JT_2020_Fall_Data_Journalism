...
read_csv("data/temperature_sensors/michael/michael_day_hourly_averages.csv")
```
...
# Write the answer in a comment
# Q: What is the average heat index value on each day inside of Stephanie's house? Which day had the highest?
# A: 7/16 - 94.8; 7/17 - 97.5; 7/18 - 97.7; 7/19 - 100.95; 7/20 - 101.1 (*HIGHEST); 7/21 - 98.25; 7/22 - 96.7
...
# Write the answer in a comment
# Q: During the seven day heat wave, what was the lowest recorded heat index value in Stephanie's house?  What was the highest heat index value, and on what day did it occur?
# A: Lowest - 88.8 (7/16); Highest - 115.7 (7/19)
...
``` {r}
michael_daily_table <- stephanie_day_hourly_averages %>%
  group_by(date) %>%
  summarize(heat_index_max = max(mean_indoor_heat_index),
            heat_index_min = min(mean_indoor_heat_index)
            average_heat_index =
    mean(mean_indoor_heat_index))
    count = n()
